...
En este ejercicio vas a aprender a inicializar el estado de un objeto usando el método constructor `__init__`.

## Concepto clave

En POO, una clase define la estructura y comportamiento.

El constructor `__init__` se ejecuta automáticamente cuando creas una instancia y sirve para guardar los datos iniciales del objeto.
...
2. Agrega un constructor `__init__` que reciba dos parámetros: `name` y `age`.
