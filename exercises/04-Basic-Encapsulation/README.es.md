# 04 Encapsulamiento basico

## Objetivo

En este ejercicio vas a practicar encapsulamiento usando atributos internos y metodos de acceso controlado.
...
4. Crea un metodo `get_name()` que retorne el nombre.
5. Crea un metodo `get_age()` que retorne la edad.
6. Crea un metodo `set_age(new_age)` que:
...
- `set_age()` valida y actualiza segun la regla definida.
